...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Web Card Qr codes</h1>
          </div><!-- /.col -->
          
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item">
                  <a href="web_card_qrcode.php" class="btn btn-success"><i class="fa fa-plus"></i> Add new</a>
                </li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
    ...
    <!-- Filters -->
    <?php $options = $web_card_qrcode_instance->setOrderingValues();
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <!-- Table -->
        <?php include BASE_PATH . '/forms/table_web_card.php'; ?>
        <!-- /.Table -->
