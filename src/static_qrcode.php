...
if ($_SERVER["REQUEST_METHOD"] === "POST" && !isset($_POST["edit"])) {
    switch ($_GET['type']) {
        case 'text':
            $static_qrcode_instance->textQrcode($_POST['text']);
            break;

        case 'email':
            $static_qrcode_instance->emailQrcode($_POST['email'], $_POST['subject'], $_POST['message']);
            break;
        ...
        case 'skype':
            $static_qrcode_instance->skypeQrcode($_POST['skype_username']);
            break;

        case 'location':
            $static_qrcode_instance->locationQrcode($_POST['latitude'], $_POST['longitude']);
            break;
        ...
        case 'event':
            $static_qrcode_instance->eventQrcode($_POST['title'], $_POST['start'], $_POST['end'], $_POST['location'], $_POST['description'], $_POST['url']);
            break;

        case 'bookmark':
            $static_qrcode_instance->bookmarkQrcode($_POST['url'], $_POST['title']);
            break;

        case 'wifi':
            $static_qrcode_instance->wifiQrcode($_POST['encryption'], $_POST['ssid'], $_POST['password']);
            break;

        case 'paypal':
            $static_qrcode_instance->paypalQrcode($_POST['payment_type'], $_POST['email'], $_POST['item_name'], $_POST['item_id'], $_POST['amount'], $_POST['currency'], $_POST['shipping'], $_POST['tax_rate']);
            break;

        case 'bitcoin':
            $static_qrcode_instance->bitcoinQrcode($_POST['address'], $_POST['amount'], $_POST['label'], $_POST['message']);
            break;
    }
}
?>
