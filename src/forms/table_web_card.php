    ...
    <div class="col-12">
        <div class="card">
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        <?php foreach ($rows as $row): ?>
                            <tr>
                                <td><input type="checkbox" name="action[]" value="<?= $row['id'] ?>"
                                        onchange="updateBulkActionVisibility()"></td>
                                <td><?= $row['id']; ?></td>
                                <td>
                                    <?php
                                ...
                                <td>
                                    ...
                                    <!-- EDIT -->
                                    <a href="web_card_qrcode.php?edit=true&id=<?= $row['id']; ?>"
                                        class="btn btn-primary">
                                        <i class="fas fa-edit"></i>
                                    </a>

                                    <!-- DELETE -->
                                    <a class="btn btn-danger delete_btn" data-toggle="modal" data-target="#delete-modal"
                                        data-del_id="<?= $row["id"]; ?>">
            ...
            <div class="card-footer clearfix">
                <?= paginationLinks($page, $total_pages, 'web_card_qrcodes.php'); ?>
            </div><!-- /.Card footer -->
...
<div class="modal fade" id="delete-modal" role="dialog">
    <div class="modal-dialog">
        <form action="web_card_qrcode.php" method="POST">
            <!-- Modal content -->
