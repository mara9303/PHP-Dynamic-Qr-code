...
<body>
    <?php if (array_key_exists("identifier", $qrcode)) { ?>
        <section id="zoom-content">
            <?php if (read_key_array($qrcode, 'logo_company', '') !== '') { ?>
                <img src="<?= get_logo(read_key_array($qrcode, 'logo_company', ''), 600) ?>" alt="Logo Prodex"
                    class="zoom-in-out-box" />
            <?php } ?>
        </section>
        <section id="web-card-content" class="didact-gothic-regular">
            <?php
            if ($qrcode['state'] == 'enable') { ?>

                <div class="container d-flex justify-content-center">
                    <?php if (!empty($qrcode['logo_company']) && $qrcode['logo_company'] == 'prodex') { ?>
                        <div class="d-flex align-items-center">
                            <img class="logos" src="dist/img/prodex-200.png" alt="Prodex logo" width="200" heigth="133">
                        </div>
                    <?php } elseif (!empty($qrcode['logo_company']) && $qrcode['logo_company'] == 'proplax') { ?>
                        <div class="d-flex align-items-center">
                ...
                <div class="container d-flex flex-column align-items-center my-3 my-sm-5">
                    <div class="card p-3 py-4">
                        <div class="text-center">
                            ...
                            <small class="mt-4 px-5 d-block d-sm-flex --"><?= read_key_array($web_card_content, "note", "") ?></small>
                        </div>
                        <div class="buttons">
                            ...
                            <div class="dropstart dropup actions download">
                                ...
                                <ul class="dropdown-menu">
                                    <li><button id="btn-vCard" class="dropdown-item"
                                            data-vcard="<?= htmlspecialchars($vCard) ?>"><i class="fas fa-save"></i></button>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div id="copyNotification" class="toast position-fixed bottom-0 mb-4 rounded-4" role="alert"
